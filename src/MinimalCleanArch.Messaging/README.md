...
## Version
- 0.1.14-preview (net9.0, net10.0). Use with `MinimalCleanArch` 0.1.14-preview and companions.
...
## Usage
```bash
dotnet add package MinimalCleanArch.Messaging --version 0.1.14-preview
```
