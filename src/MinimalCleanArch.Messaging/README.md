...
## Version
-0.1.12-preview (net9.0, net10.0). Use with `MinimalCleanArch`0.1.12-preview and companions.
...
## Usage
```bash
dotnet add package MinimalCleanArch.Messaging --version0.1.12-preview
```
