...
## Version
- 0.1.13-preview (net9.0, net10.0). Use with `MinimalCleanArch` 0.1.13-preview and `MinimalCleanArch.Extensions`.
...
## Usage
```bash
dotnet add package MinimalCleanArch.Validation --version 0.1.13-preview
```
